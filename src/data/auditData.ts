...
const SEED: AuditEntry[] = [
  { id: 'aud-1', when: '2026-04-08T09:12:00Z', actor: 'Alex Rahman', actorRole: 'super_admin', entity: 'purchase', entityId: 'pur1', action: 'purchase.created', before: null, after: { vendor: 'poxami', lines: 3, totalQty: 203 }, ip: '10.0.1.12', eventId: 'evt1', eventName: 'FIFA World Cup 2026' },
  { id: 'aud-2', when: '2026-04-08T10:30:00Z', actor: 'Sara Al Mansoori', actorRole: 'ops_manager', entity: 'sale', entityId: 'sale001', action: 'sale.created', before: null, after: { client: 'Roadtrips', lines: 3, totalQty: 38 }, ip: '10.0.1.15', eventId: 'evt1', eventName: 'FIFA World Cup 2026' },
  ...
  { id: 'aud-8', when: '2026-04-09T09:00:00Z', actor: 'James Patel', actorRole: 'sr_operator', entity: 'credential', entityId: 'vc3', action: 'credential.create', before: null, after: { vendorId: 'vnd2', loginId: 'viagogo.f1sgp' }, ip: '10.0.1.20', eventId: 'evt2', eventName: 'F1 Singapore GP 2026' },
  { id: 'aud-9', when: '2026-04-09T09:30:00Z', actor: 'Priya Nair', actorRole: 'operator', entity: 'purchase', entityId: 'pur2', action: 'purchase.created', before: null, after: { vendor: 'viagogo', lines: 2, totalQty: 50 }, ip: '10.0.1.25', eventId: 'evt2', eventName: 'F1 Singapore GP 2026' },
...
export const MOCK_PURCHASE_UNITS_AUDIT: PurchaseUnitsAuditRow[] = [
  { id: 'pua-1', checkedAt: '2026-04-09T08:00:00Z', source: 'pur1', match: 'M01', game: 'Main Match', vendor: 'poxami', contract: '2025-100129', category: 'Top Cat 1', purchaseQty: 43, unitsBefore: 43, allocated: 12, finalCount: 43, issue: 'NONE' },
  { id: 'pua-2', checkedAt: '2026-04-09T08:00:00Z', source: 'pur1', match: 'M01', game: 'Main Match', vendor: 'poxami', contract: '2025-100129', category: 'Cat 2', purchaseQty: 100, unitsBefore: 102, allocated: 6, finalCount: 100, issue: 'EXTRA_AVAILABLE_ROWS_REMOVED' },
  { id: 'pua-3', checkedAt: '2026-04-09T08:00:00Z', source: 'pur1', match: 'M01', game: 'Main Match', vendor: 'poxami', contract: '2025-100129', category: 'Cat 3', purchaseQty: 60, unitsBefore: 58, allocated: 20, finalCount: 60, issue: 'MISSING_ROWS_ADDED' },
  { id: 'pua-4', checkedAt: '2026-04-09T08:01:00Z', source: 'pur2', match: 'SGP-WKD', game: 'Qualifying', vendor: 'viagogo', contract: '2025-100888', category: 'Grandstand A', purchaseQty: 30, unitsBefore: 30, allocated: 0, finalCount: 30, issue: 'NONE' },
  { id: 'pua-5', checkedAt: '2026-04-09T08:01:00Z', source: 'pur2', match: 'SGP-WKD', game: 'Grand Prix', vendor: 'viagogo', contract: '2025-100888', category: 'Paddock Club', purchaseQty: 20, unitsBefore: 22, allocated: 0, finalCount: 20, issue: 'EXTRA_AVAILABLE_ROWS_REMOVED' },
];
